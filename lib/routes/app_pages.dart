...
import '../pages/favorite/favorite_list/favorite_list_binding.dart';
import '../pages/favorite/favorite_list/favorite_list_view.dart';
import '../pages/favorite/favorite_detail/favorite_detail_binding.dart';
import '../pages/favorite/favorite_detail/favorite_detail_view.dart';
import '../pages/favorite/category_management/category_management_binding.dart';
import '../pages/favorite/category_management/category_management_view.dart';
import '../pages/favorite/favorite_search/favorite_search_binding.dart';
import '../pages/favorite/favorite_search/favorite_search_view.dart';
import '../pages/favorite/favorite_stats/favorite_stats_binding.dart';
import '../pages/favorite/favorite_stats/favorite_stats_view.dart';
...
import '../pages/chat/chat_setup/search_chat_content/search_chat_content_binding.dart';
import '../pages/chat/chat_setup/search_chat_content/search_chat_content_view.dart';
...
class AppPages {
  ...
  static final routes = <GetPage>[
    ...
    _pageBuilder(
      name: AppRoutes.favoriteSearch,
      page: () => FavoriteSearchPage(),
      binding: FavoriteSearchBinding(),
    ),
    _pageBuilder(
      name: AppRoutes.favoriteStats,
      page: () => FavoriteStatsPage(),
      binding: FavoriteStatsBinding(),
    ),
    _pageBuilder(
    ...
    _pageBuilder(
      name: AppRoutes.searchChatContent,
      page: () => SearchChatContentPage(),
      binding: SearchChatContentBinding(),
    ),
    _pageBuilder(
