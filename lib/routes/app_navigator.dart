...
class AppNavigator {
  ...
  static startSearchChatContent({
    required ConversationInfo conversationInfo,
  }) =>
      Get.toNamed(AppRoutes.searchChatContent, arguments: {
        'conversationInfo': conversationInfo,
      });
  ...
  /// 收藏列表页面
  static startFavoriteList() => Get.toNamed(AppRoutes.favoriteList);

  /// 收藏详情页面
  static startFavoriteDetail({required FavoriteInfo favoriteInfo}) => Get.toNamed(
        AppRoutes.favoriteDetail,
        arguments: {"favoriteInfo": favoriteInfo},
      );

  /// 收藏搜索页面
  static startFavoriteSearch() => Get.toNamed(AppRoutes.favoriteSearch);

  /// 分类管理页面
  static startCategoryManagement() => Get.toNamed(AppRoutes.categoryManagement);

  /// 收藏统计页面
  static startFavoriteStats() => Get.toNamed(AppRoutes.favoriteStats);

  /// 收藏编辑页面
  static startFavoriteEdit({required FavoriteInfo favoriteInfo}) => Get.toNamed(
        AppRoutes.favoriteEdit,
        arguments: {"favoriteInfo": favoriteInfo},
      );

  /// 图片预览页面
  static startPreviewImage({
