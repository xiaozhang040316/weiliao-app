      ...
      body: Obx(() => SingleChildScrollView(
            child: Column(
              children: [
                ...
                _buildItemView(
                  text: '走势图',
                  switchOn: logic.isLotteryEnabled.value,
                  showSwitchButton: true,
                  isTopRadius: true,
                  isBottomRadius: true,
                  onChanged: (_) => logic.toggleLottery(),
                ),
                10.verticalSpace,
                _buildItemView(
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  "查找聊天内容".toText..style = Styles.ts_0C1C33_16sp,
                  2.verticalSpace,
                  "聊天记录、图片、视频、文件".toText..style = Styles.ts_8E9AB0_12sp,
                ],
              ),
            ),
            Icon(
