...
class UserProfilePanelPage extends StatelessWidget {
          ...
          body: SizedBox(
            ...
            child: Stack(
              children: [
                ...
                // 只有好友才显示音视频通话和发消息按钮
                if (logic.isFriendship && !logic.isMyself) _buildButtonGroup(),
                // 非好友时显示添加好友按钮
                if (!logic.isMyself &&
  ...
  Widget _buildDeleteFriendButton() => Container(
  ...
  /// 添加好友按钮（底部显示）
  Widget _buildAddFriendButton() => Positioned(
        bottom: 0.h,
        width: 1.sw,
        child: ClipRRect(
          child: BackdropFilter(
                        ...
                        child: Row(
                          ...
                          children: [
                            ImageRes.addContacts.toImage
                              ...
                              ..color = Styles.c_FFFFFF,
                            8.horizontalSpace,
                            StrRes.addFriend.toText..style = Styles.ts_FFFFFF_17sp_medium,
                          ],
                        ),
                      ),
                    ),
