...
class PublishCirclePage extends StatelessWidget {
  PublishCirclePage({super.key});

  final logic = Get.find<PublishCircleLogic>();
  ...
  Widget _buildCircleSelector() => Obx(
        () => _buildItemView(
          icon: ImageRes.circle,
          text: '所属圈子',
          showUnderline: false,
          onTap: logic.chooseCircle,
          value: logic.selectedCircle.value?.circleName ?? '请选择圈子',
        ),
      );
          ...
          children: [
            ...
            Positioned(
              ...
              child: GestureDetector(
                onTap: () => logic.deleteAssets(index),
                child: Container(
                  width: 20.w,
                  height: 20.h,
