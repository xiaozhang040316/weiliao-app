...
class ChatItemView extends StatefulWidget {
  ...
  final bool enabledFavoriteMenu;
  ...
  final Function()? onTapFavoriteMenu;
...
class _ChatItemViewState extends State<ChatItemView> {
  ...
  List<MenuInfo> get _menusItem => [
        ...
        if (widget.enabledFavoriteMenu)
          MenuInfo(
            icon: ImageRes.menuFavorite,
            text: StrRes.menuFavorite,
            enabled: widget.enabledFavoriteMenu,
