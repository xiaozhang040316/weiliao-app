...
class ImageRes {
  ...
  static const homeTab1Nor = "$_dir/ic_home_tab1_nor.png";  // 消息-未选中 PNG
  static const homeTab2Nor = "$_dir/ic_home_tab2_nor.png";  // 通讯录-未选中 改为PNG
  static const homeTab3Nor = "$_dir/ic_home_tab3_nor.png";  // 发现-未选中 改为PNG
  static const homeTab4Nor = "$_dir/ic_home_tab4_nor.png";  // 我的-未选中 改为PNG
  static const homeTab1Sel = "$_dir/ic_home_tab1_sel.png";  // 消息-选中 PNG
  static const homeTab2Sel = "$_dir/ic_home_tab2_sel.png";  // 通讯录-选中 改为PNG
  static const homeTab3Sel = "$_dir/ic_home_tab3_sel.png";  // 发现-选中 改为PNG
  static const homeTab4Sel = "$_dir/ic_home_tab4_sel.png";  // 我的-选中 改为PNG
  ...
  static const animatedStickerTab = "$_dir/ic_animated_sticker_tab.webp";
  ...
  static const menuFavorite = "$_dir/ic_menu_favorite.webp";
  ...
  // Voice icon located under assets/images/voice.webp (package asset root)
  static const voice = "$_dir/voice.webp";
  // Inactive voice icon for initial state
  static const voiceDead = "$_dir/voice_dead.webp";
